...
class Button extends Component {
  ...
  handleClick(event){
    this.setState({
      DEPARTMENT: document.getElementById("input").value
    }, () => {
      const x = "https://www.eg.bucknell.edu/~amm042/service/q?Semester=Fall&Year=2018&Department=" + this.state.DEPARTMENT.toUpperCase()
      console.log(x)
      fetch(x)
